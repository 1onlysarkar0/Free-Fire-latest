...
import { HomepageOgData } from "../index";

export function HomepageOgTemplate({ data }: { data: HomepageOgData }) {
  return (
    <div
      style={{
        display: "flex",
        ...
        backgroundImage: "radial-gradient(circle at 0% 0%, #FFE9E0 0%, #FAF8F5 50%)",
        padding: "80px",
