...
import { CustomPageOgData } from "../index";

export function CustomPageOgTemplate({ data }: { data: CustomPageOgData }) {
  return (
    <div
      style={{
        display: "flex",
        ...
        backgroundImage: "radial-gradient(circle at 100% 0%, #FFE9E0 0%, #FAF8F5 50%)",
        padding: "80px",
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        >
          <span style={{ color: "#FFF", fontSize: "24px", fontWeight: "bold" }}>1</span>
        </div>
