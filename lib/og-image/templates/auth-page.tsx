...
import { AuthPageOgData } from "../index";

export function AuthPageOgTemplate({ data }: { data: AuthPageOgData }) {
  return (
    <div
      style={{
        display: "flex",
        ...
        backgroundImage: "radial-gradient(circle at 0% 100%, #FFE9E0 0%, #FAF8F5 50%)",
        padding: "80px",
