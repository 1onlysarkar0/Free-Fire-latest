...
function FaqProRow({
  ...
  return (
    <div className="overflow-hidden rounded-2xl bg-muted/70 dark:bg-muted/30 border border-border">
      <button
        ...
        type="button"
      >
        <span className="font-semibold text-[15px] text-foreground leading-6 tracking-[-0.02em]">
    ...
    >
      <div className="relative">
        <input
          ...
          className={cn(
            "h-12 w-full appearance-none rounded-full border border-border bg-card px-5 pr-11 text-[15px] text-foreground",
            "shadow-sm outline-none focus:outline-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
