...
export default function SmtpClient({ initialData }: { initialData: SmtpData }) {
  ...
  if (!data) return (
    <div className="p-4 md:p-6 w-full">
      <div className="rounded-2xl bg-accent/40 shadow-sm animate-pulse p-8">
      ...
      <div className="space-y-6">
        ...
        <Card className="rounded-2xl bg-accent/60 shadow-sm">
          <CardContent className="p-6 space-y-5">
            <div className="flex items-center justify-between p-4 rounded-xl bg-background/60 border">
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-background/60 border">
