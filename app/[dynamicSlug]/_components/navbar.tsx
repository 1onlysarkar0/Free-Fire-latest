...
export default function AdminNavbar({ userName, userImage, isAdmin }: AdminNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 h-14 bg-background/70 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 border-b border-border/20 flex items-center px-3 md:px-6 gap-3 shrink-0">
